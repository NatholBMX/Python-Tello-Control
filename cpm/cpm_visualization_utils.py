...
cpm_model = importlib.import_module('cpm.models.nets.' + FLAGS.network_def)
...
def main():
    ...
    with tf.Session(config=sess_config) as sess:
        ...
        if FLAGS.model_path.endswith('pkl'):
            ...
            saver.restore(sess, 'cpm/models/weights/cpm_hand')
        ...
        if FLAGS.DEMO_TYPE.endswith(('png', 'jpg')):
            ...
            test_img = cpm_utils.read_image(img, [], FLAGS.input_size, 'CVIMAGE')
        ...
        elif FLAGS.DEMO_TYPE in ["CVIMAGE"]:
            while True:
                # # Prepare input image
                full_img = get_input_image()
...
def set_input_image(input_image):
    global img
    img = input_image
